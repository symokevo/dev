...
interface SeriesStatesHoverOptionsObject extends Highcharts.SeriesStatesHoverOptionsObject {
  marker: object;
}
...
interface ExtendedZoom extends Highcharts.ChartOptions {
  zoomType: string;
}
...
export class StackbarChartComponent2 {
  ...
  chartOptions: Highcharts.Options = {
    ...
    title: {
      text: 'Height V/s Weight of Muranga University of Technology',
    },
    xAxis: {
      title: {
        enabled: true,
